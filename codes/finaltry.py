...
SEARCH_QUERY = SEARCH_QUERY = '("LG OLED" OR "LG Smart TV" OR "LG AC" OR "LG refrigerator" OR "LG microwave" OR "LG washing machine" OR "LG India") India -from:LGIndia -from:LG_Global since:2022-05-01 until:2023-01-01'
MAX_TWEETS = 1000
...
def scrape_lg_tweets():
    ...
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(15000)  # 15 secs
        ...
        print("abc")
        scroll_attempts = 0
        while len(tweets) < MAX_TWEETS and scroll_attempts <200:
